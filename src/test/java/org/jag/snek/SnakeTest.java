...
public class SnakeTest {
    ...
    public void snakeDiesWhenRunningIntoItselfTest() {
        Snake s = new Snake(new Coordinate(4, 5));
        snake.getTails().add(new SnakeTail(new Coordinate(5, 5)));
        s.setDirection(Direction.RIGHT);
        assertTrue(s.isAlive(), "Snake should still be alive");
        s.completeCycle(field);
        assertFalse(s.isAlive(), "Snake should run into a Tail");
    }
