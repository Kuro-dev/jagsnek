...
public class SnakeTest {
    ...
    public void testLengthStaysTheSame() {
        ...
        assertEquals(4, snake.getTails().size(), "The size of the snake should not change");
        assertEquals(5, snake.getSize(), "The size of the snake should not change");
    ...
    public void snakeGrowsWhenEatingFood() {
        ...
        //check initial state
        assertEquals(4, snake.getTails().size());
        assertEquals(5, snake.getSize());
        //do a cycle
        snake.completeCycle(field);
        //check expected state
        assertEquals(new Coordinate(5, 5), snake.getPosition());
        assertEquals(6, snake.getSize(), "The snake should grow in size after landing on the snack tile");
        assertEquals(5, snake.getTails().size(), "The snake should grow in size after landing on the snack tile");
